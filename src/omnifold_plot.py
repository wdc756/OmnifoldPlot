...
ex_plot_pat = Pattern([Token('set', ex_sets.values), Token('percent', ex_percents.values),
...
# plot_options.append(PlotOptions(ex_points, ex_shift, ex_plot_dir, ex_plot_pat, ex_verbose, ex_use_numpy_histogram,
#                                        ex_use_symmetric_percent_error, ex_calculate_std_dev_using_datapoints,
#                                        ex_normalize_std_dev, ex_normalize_y_axis, ex_use_symlog_yscale))
...
plot_options.append(PlotOptions(test_points, test_shift, test_plot_dir, test_plot_pat, test_verbose, test_use_numpy_histogram,
                                       test_use_symmetric_percent_error, test_calculate_std_dev_using_datapoints,
                                       test_normalize_std_dev, test_normalize_y_axis, test_use_symlog_yscale))
